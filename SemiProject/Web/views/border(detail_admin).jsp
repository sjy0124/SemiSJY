		...
		<div class="container" role="main">
			...
			<form name="form" id="form" role="form" method="post" action="${pageContext.request.contextPath}/board/saveBoard" aria-readonly="true">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" name="title" id="title" value="1월 14일 공지사항 입니다.">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" name="reg_id" id="reg_id" value="문사장">
				...
				<div class="mb-3">
					...
					<input type="text" class="form-control" name="tag" id="tag" value="#행정부">
